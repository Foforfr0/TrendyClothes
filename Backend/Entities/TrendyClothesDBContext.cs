...
public partial class TrendyClothesDBContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Addresse__3214EC07F505D464");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Auctions__3214EC07F4E7EF55");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Categori__3214EC07ECE2B563");

            entity.ToTable("CategoriesProduct");

            entity.HasIndex(e => e.Category, "UQ__Categori__4BB73C322B835CA0").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PhotosPr__3214EC0771A1E945");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Products__3214EC075703ED43");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__QAProduc__3214EC078D91111A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__RolesUse__3214EC07224EB1B5");

            entity.ToTable("RolesUser");

            entity.HasIndex(e => e.Role, "UQ__RolesUse__DA15413E2BFD5EBE").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Statuses__3214EC07DDBB2831");

            entity.ToTable("StatusesAuction");

            entity.HasIndex(e => e.Status, "UQ__Statuses__3A15923FAD19E677").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Statuses__3214EC078BB5871D");

            entity.ToTable("StatusesProduct");

            entity.HasIndex(e => e.Status, "UQ__Statuses__3A15923FD1432C93").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__TypesPro__3214EC07F5BFC54B");

            entity.ToTable("TypesProduct");

            entity.HasIndex(e => e.Type, "UQ__TypesPro__F9B8A48B00ED455A").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Users__3214EC078B853B1F");

            entity.HasIndex(e => e.Username, "UQ__Users__536C85E4873100B6").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Users__A9D10534C8EA00A4").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__User_Add__3214EC07D4ED6C91");
