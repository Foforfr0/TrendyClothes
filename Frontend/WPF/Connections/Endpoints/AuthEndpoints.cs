namespace WebPage.Connections
{
    ...
    public static class ProductEndpoints
    {
        ...
        private const string BaseUrl3 = "http://localhost:5000/Product/Buyer";

        //search
        public static string GetProducts(string query) => $"{BaseUrl3}/ConsultProducts?query={Uri.EscapeDataString(query)}";
