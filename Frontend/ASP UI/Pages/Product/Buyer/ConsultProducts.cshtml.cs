...
namespace WebPage.Pages.Product.Buyer {
    public class ConsultProductsModel : PageModel {
        ...
        public ConsultProductsModel (IHttpClientFactory httpClientFactory, ServicesBuilder services, ImageProductService.ImageProductServiceClient grpcClient, ILogger<ConsultProductsModel> logger) {
